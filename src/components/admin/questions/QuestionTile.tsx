...
export default function QuestionTile({questionSuggestion, suggestion, j}: {questionSuggestion: QuestionSuggestion, suggestion: Suggestion, j: number}) {
    ...
    function onEditSvg(e: React.MouseEvent<HTMLButtonElement>) {
        e.preventDefault()
        dispatch({type: "editSuggestionSvg", editSuggestion: suggestion, editQuestion: questionSuggestion})
