...
export default function AdminMain() {
    ...
    return (
        <>
            {profile ? (displayPage(page)) : (
                <div className="flex justify-center align-middle h-lvh">
                    <div className="flex my-auto align-middle h-12">
                        <div className="flex align-middle"><img src="/google_logo.png" alt={signinText}
                                                                className="block my-auto w-6 h-6 mr-1"/></div>
                        <div className="flex align-middle">
                            <button className="text-xl" onClick={() => login()}>{signinText}</button>
                        </div>
                    </div>
                </div>
            )}
