...
export default function SuggestedConsultants() {
    ...
    const {consultantRatings, updatingSuggestedConsultants, suggestedConsultantsError, setSuggestedConsultantsError} =
                    ...
                    return (
                        <div key={`rating_${i}`} className="mt-4 md:mt-8">
                            ...
                            <div className="flex flex-wrap">
                                ...
                                <div className="w-full md:w-[20%] font-bold">{t("LinkedIN")}</div>
                                <div className="w-full md:w-[80%]"><a href={rating.analyst_linkedin_url} target="_blank"
                                                                      className="underline">{rating.analyst_linkedin_url}</a>
                                </div>
                                <div className="w-full md:w-[20%] font-bold">{t("Reasoning")}</div>
