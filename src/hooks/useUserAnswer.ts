...
function handleNewMessage(newMessage: Message,
                          ...
                          setExpectedNodes: (expectedNodes: number) => void): number {
      ...
      .then((response: BoomiMessage) => {
        ...
        if (code === SUCCESS && !!data) {
          ...
          if (!!question && !hasRecommendations) {
            ...
            const messageCount = handleNewMessage(newMessage, expectedNodes, setMessages, setCurrentMessage, setCurrentMessageHistory, setExpectedNodes);
