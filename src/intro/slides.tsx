...
export function getIntroSlides() {
  return [
    ...
    },
    {
      ...
      image: `./screenshots/${window.dataWellnessConfig?.imageFolder || "res-ai"}-screenshot-3.png`,
      video: null,
      buttonText: null,
      buttonOnclick: null,
    },
    ...
    },
    {
      ...
      image: `./screenshots/${window.dataWellnessConfig?.imageFolder || "res-ai"}-screenshot-5.png`,
      video: null,
