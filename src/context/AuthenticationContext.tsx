import {googleLogout, OverridableTokenClientConfig, TokenResponse, useGoogleLogin} from "@react-oauth/google";
...
export const AuthenticationContextProvider = ({ children }: Props) => {
    ...
    const login: (overrideConfig?: OverridableTokenClientConfig) => void = useGoogleLogin({
    ...
    return <AuthenticationContext.Provider value={{user, setUser, profile, setProfile, login, logOut}} >{children}</AuthenticationContext.Provider>
}
